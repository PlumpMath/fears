...
get the app created:
    ...
    $ heroku apps:create fears
    Creating fears... done, stack is cedar
    http://fears.herokuapp.com/ | git@heroku.com:fears.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://fears.herokuapp.com deployed to Heroku

    To git@heroku.com:fears.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://fears.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@fears.herokuapp.com/repl
